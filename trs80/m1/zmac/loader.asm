...
XMEM		equ 	67	; use upper 32 KB page mode 8000 - FFFF
...
title3		ascii  'Enter max. page number <n> (SONG0/MID - SONG<n>/MID): ', ENTER
...
rloop:  
	...
	;;push bc 
	;; clear io buffer with 255 (end of song)
	;;ld hl, emptyiobuf
	;;ld de, iobuf
	;;ld bc, 256 
	;;ldir 			; hl -> de / bc bytes
...
rok:    ld	hl,iobuf	; source hl; de = mididata
